...
const CMD_GROUPS: CmdGroup[] = [
  ...
  },
  {
    ...
    cmds: [
      ...
      { label: '⚔ Attack', cmd: 'set_army_attack', key: 'A' },
      { label: '🛡 Defend', cmd: 'set_army_defend' },
      { label: '🏰 Garrison', cmd: 'set_army_garrison', key: 'G' },
      { label: '👁 Scout', cmd: 'set_army_scout' },
      { label: '👑 Rule', cmd: 'set_army_rule' },
      { label: '🚩 March', cmd: 'set_army_march' },
      { label: '✂ Split (-)', cmd: 'split_army', key: '-' },
      { label: '⊕ Combine', cmd: 'combine_army' },
      { label: '÷ Divide (/)', cmd: 'divide_army', key: '/' },
    ],
  },
  {
    name: 'Navy',
    collapsed: true,
    cmds: [
      { label: '📥 Load Fleet', cmd: 'load_fleet' },
      { label: '📤 Unload Fleet', cmd: 'unload_fleet' },
      { label: '🚢 Build Ship', cmd: 'build_ship' },
    ],
  },
  {
    name: 'Actions',
    cmds: [
      ...
      { label: '💰 Budget', cmd: 'show_budget', key: 'B' },
      { label: '💬 Chat', cmd: 'toggle_chat', key: 'T' },
      { label: '🏗 Redesignate', cmd: 'redesignate', key: 'R' },
      { label: '👥 Draft', cmd: 'draft', key: 'P' },
      { label: '🏰 Build Fort', cmd: 'build_fort', key: 'F' },
      { label: '🛤 Build Road', cmd: 'build_road', key: 'W' },
      { label: '🤝 Diplomacy', cmd: 'diplomacy', key: 'X' },
      { label: '💂 Hire Mercs', cmd: 'hire_mercs' },
      { label: '💰 Bribe', cmd: 'bribe' },
      { label: '🎁 Tribute', cmd: 'send_tribute' },
  ...
  },
  {
    ...
    collapsed: true,
    cmds: [
      { label: '✨ Cast Spell', cmd: 'cast_spell', key: 'Z' },
      { label: '📖 Buy Power', cmd: 'buy_power', key: 'Q' },
    ],
  },
  {
    name: 'Trade',
    collapsed: true,
    cmds: [
      { label: '💲 Propose Trade', cmd: 'propose_trade', key: '$' },
      { label: '📨 Pending Trades', cmd: 'pending_trades' },
    ],
  },
  {
    name: 'View',
