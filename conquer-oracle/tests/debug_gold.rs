...
fn debug_gold_flow_per_phase() {
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "Phase", "N1", "N2", "N3", "N12", "N14");
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "initial",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
    ...
    for loop_idx in 0..active_count {
        ...
        if gs.nations[country].active == 0 { continue; }
        let strat = NationStrategy::from_value(gs.nations[country].active);
        if strat.map_or(false, |s| s.is_npc()) {
            let _news = conquer_engine::npc::nation_run(&mut gs, country, &mut rng);
        }
        // Leader check
        let leader_type = conquer_engine::utils::getleader(gs.nations[country].class).wrapping_sub(1);
    ...
    for country in 1..NTOTAL {
        ...
        if rng.rand() % 4 == 0 { gs.nations[country].spell_points /= 2; }
    }
    
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "updexecs",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "monsters",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "combat",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "capture",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "trade",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "updmil",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "events",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "updsectors",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    for &ni in &[3usize, 12] {
        ...
        eprintln!("  Pre-updcomod N{}: gold={} jewels={} excess={} (will buy? {})",
            ni, gold, jewels, excess, excess > 0);
    }
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "updcomod",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "leaders",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "att_base",
        gs.nations[1].treasury_gold, gs.nations[2].treasury_gold,
        gs.nations[3].treasury_gold, gs.nations[12].treasury_gold,
        gs.nations[14].treasury_gold);
    ...
    eprintln!("{:>12} {:>10} {:>10} {:>10} {:>10} {:>10}", "C expected",
        en[1].tgold, en[2].tgold, en[3].tgold, en[12].tgold, en[14].tgold);
    
    eprintln!("\n=== GOLD DELTAS (Rust - C) ===");
    for i in [1, 2, 3, 12, 14] {
        let diff = gs.nations[i].treasury_gold - en[i].tgold;
        eprintln!("  Nation {:2} ({}): Rust={} C={} diff={:+}",
